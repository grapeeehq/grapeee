...
const workflowSteps = [
  {
    ...
    body: "New feature, cleanup, polish, or a first draft. Start with a simple request.",
  },
  {
    title: "Get a focused response",
    body: "The app turns your request into something concrete instead of flooding you with noise.",
  },
  {
    title: "Move forward with confidence",
    body: "You can review what matters and keep momentum without giving up the final say.",
  },
];
    ...
    <main className={`lp ${editorial.variable}`}>
        ...
        <div className="lp-shell lp-hero-inner">
          <div className="lp-hero-copy">
            ...
            <h1 className="lp-title">
              Build Roblox games faster without losing your place in the process
      ...
      <section className="lp-chapter lp-chapter-light" id="workflow">
        <div className="lp-shell lp-section-head">
          <div>
            <p className="lp-section-kicker">Why it feels easy</p>
            <h2>A calmer way to go from prompt to progress.</h2>
          </div>
          <p className="lp-section-copy">
            The experience should feel simple on day one: ask for help, understand what is
            happening, and keep moving.
          </p>
        </div>
      ...
      <section className="lp-chapter lp-chapter-dark" id="proof">
        <div className="lp-shell lp-proof-grid">
          <div className="lp-proof-copy">
            ...
            <h2>It is designed to feel useful fast, not overwhelming fast.</h2>
            <p>
              New users should feel guided, not buried in jargon. The product should make the next
              move clearer, not louder.
            </p>

            <div className="lp-quote">
              <div className="lp-quote-avatars" aria-hidden="true">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://picsum.photos/seed/grapeee-1/96/96" alt="" />
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://picsum.photos/seed/grapeee-2/96/96" alt="" />
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://picsum.photos/seed/grapeee-3/96/96" alt="" />
              </div>
              <p>
                “The best kind of AI help feels clear right away. You know what it is doing, and
                you never feel lost inside it.”
              </p>
            </div>
          </div>
          ...
          <div className="lp-stack">
            {workflowSteps.map((step, index) => (
              <article key={step.title} className={`lp-stack-card lp-stack-card-${index + 1}`}>
                <span className="lp-stack-index">0{index + 1}</span>
                <h3>{step.title}</h3>
                <p>{step.body}</p>
              </article>
            ))}
      ...
      <style>{`
        ...
        .lp-stack-card-1 { top: 112px; }
        .lp-stack-card-2 { top: 146px; }
        .lp-stack-card-3 { top: 180px; }
