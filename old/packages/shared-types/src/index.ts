...
export type RuntimeHostKind = "daemon" | "studio-plugin";

export type RuntimePairingStatus = "pending" | "authorized" | "expired";
...
export interface RuntimePairingStartRequest {
  deviceName?: string;
  hostKind?: RuntimeHostKind;
}

export interface RuntimePairingStartResponse {
  pairingId: string;
  pollToken: string;
  code: string;
  deviceName: string;
...
export interface RuntimePairingStatusResponse {
  pairingId: string;
